        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:dev.souravramesh@gmail.com" className="text-gray-600 hover:text-black transition-colors">
                    dev.souravramesh@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Koratty, India</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white py-3 px-6 rounded-lg hover:bg-gray-700 transition-colors font-medium flex items-center justify-center gap-2"
              >
                <Send size={20} />
                Send Message
              </button>
